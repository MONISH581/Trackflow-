      ...
      <div className="glass-card p-6 border border-slate-200 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          >
            ...
            <span className="ml-1 px-1.5 py-0.5 text-xs bg-indigo-100 text-indigo-700 rounded-full font-extrabold">6h Auto</span>
          </button>
                  ...
                  {FEATURED_PLATFORMS.map((platform) => (
                    ...
                    >
                      <div>
                        ...
                        <p className="text-xs text-slate-500 line-clamp-2"><span className="font-semibold text-slate-700">Why use it:</span> {platform.why}</p>
                      </div>
                      <div className="mt-2 text-xs font-bold text-indigo-600 bg-indigo-50 w-fit px-2 py-0.5 rounded-full border border-indigo-100">
                        {platform.tag}
                      </div>
                    </a>
                  ))}
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  {PRIORITY_PLATFORMS.map((item, idx) => (
                    ...
                    >
                      <div className="w-6 h-6 rounded-lg bg-emerald-600 text-white font-bold text-xs flex items-center justify-center shrink-0 shadow-sm">
                        #{idx + 1}
                      </div>
      ...
      {activeTab === "verification" && isTeacher && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
            ...
            >
              <p className="text-xs font-extrabold uppercase tracking-wider text-slate-500">Total Proofs</p>
            ...
            >
              <p className="text-xs font-extrabold uppercase tracking-wider text-amber-700">Pending Review</p>
            ...
            >
              <p className="text-xs font-extrabold uppercase tracking-wider text-emerald-700">Approved & Valid</p>
            ...
            >
              <p className="text-xs font-extrabold uppercase tracking-wider text-rose-700">Rejected</p>
            ...
            >
              <p className="text-xs font-extrabold uppercase tracking-wider text-slate-600">Expired (1-Mo)</p>
          ...
          <div id="verification-history-list" className="p-4 bg-white rounded-2xl border border-slate-200 flex flex-col lg:flex-row lg:items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <select
                ...
                className="px-3 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-700 text-xs font-bold cursor-pointer focus:outline-none focus:border-indigo-600 max-w-[min(100%,_220px)] truncate"
              >
